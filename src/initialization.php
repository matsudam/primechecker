<?php
	...
	define ('SERVICE', '素数チェッカー');				// サービス名

	// テスト環境と本番環境のDBの切り替え
	if(stristr($_SERVER["HTTP_HOST"], "test")){
		define('HOME_URL', 'http://test.hanak.in/primechecker/');
		define('DOC_ROOT', '/var/www/test/hanak.in/primechecker/');
		define('DB_URI'  , 'localhost');
		define('DB_NAME' , 'prime');
		define('DB_USER' , 'prime');
		define('DB_PASS' , 'DSz6W4WW9VJdWhtR');
	}else{
		define('HOME_URL', 'http://hanak.in/primechecker/');
		define('DOC_ROOT', '/var/www/site/hanak.in/primechecker/');
		define('DB_URI'  , 'localhost');
		define('DB_NAME' , 'prime');
		define('DB_USER' , 'prime');
		define('DB_PASS' , 'DSz6W4WW9VJdWhtR');
